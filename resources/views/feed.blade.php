  ...
  <main class="flex flex-col gap-4 overflow-y-auto grow py-4 px-4 -mx-4">
    ...
    <div class="flex mt-8 gap-4 items-start  border-b border-pixl-light/10 pb-4">
      ...
      <form action="" class="grow">
        ...
        <textarea class="w-full text-lg resize-none" name="post" id="post" placeholder="What's up _adrian?" rows="5"></textarea>
        <div class="flex justify-between gap-4 items-center">
          ...
          <button type="submit" class="bg-pixl px-4 py-1 text-sm text-pixl-dark border border-transparent hover:bg-pixl/15 active:bg-pixl/20">Post</button>
        </div>
      </form>
    </div>
