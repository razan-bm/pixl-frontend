...
<body class="bg-pixl-dark text-pixl-light flex gap-16 p-4 sm:h-dvh sm:overflow-clip">
  <!-- navigation -->
  <header class="w-48 xl:ml-40 shrink-0 my-4 pl-4 hidden sm:flex gap-8 justify-between flex-col">
    <!-- logo -->
    <div class=" overflow-y-auto">
      ...
      <nav class="mt-10">
        <ul class="flex flex-col gap-3.5">
          ...
          <!-- active -->
          <li class="-ml-4 flex gap-2 items-center"><span class="bg-pixl size-2 shrink-0"></span><a href="#" class="hover:underline">Notifications</a></li>
          ...
          <li><a href="#" class="hover:underline">Communities</a></li>
    ...
    <div class="flex flex-col gap-6">
      <button type="submit" class="bg-pixl px-4 py-3 text-sm text-pixl-dark border border-transparent hover:bg-pixl/15 active:bg-pixl/20">Post</button>
      <div class="gap-3.5 flex">
        ...
        <div clas="flex flex-col gap-1 text-sm">
          <p>_adrian</p>
          <p class="text-pixl-light/60">@tudssss</p>
        </div>
        <button class="flex gap-0.75 group py-2 cursor-pointer" aria-label="More options">
  ...
  <main class="flex flex-col gap-4 overflow-y-auto grow py-4 px-4 -mx-4">
    ...
    <header>
      ...
      <div class="flex items-end gap-4 -mt-10 md:-mt-16 justify-between flex-wrap   ">
        <div class="flex items-end gap-4">
          <img src="/images/adrian.png" alt="Avatar for Adrian" class="size-20 md:size-32 object-cover">
          <div class="flex flex-col md:gap-1 text-sm">
            <p class="text-lg md:text-xl">_adrian</p>
            <p class="text-pixl-light/60">@tudssss</p>
          </div>
        </div>
        <a href="#" class="bg-pixl-dark/50 hover:bg-pixl-dark/60 active:bg-pixl-dark/75 border border-pixl/50 hover:border-pixl/60 active:border-pixl/75 px-2 py-1 text-pixl">Edit Profile</a>
      </div>
      <div class="mt-8 [&_a]:text-pixl [&_a]:hover:underline">
        <p>I design <a href="#">@Laracasts</a> so hit me whenever :]</p>
      </div>
      <dl class="flex mt-6 gap-6">
    ...
    <div class="h-full mt-6">
      <nav class="overflow-x-auto scrollbar-none">
        <ul class="flex gap-8 justify-end text-sm w-max">
          <li><a href="#" class="whitespace-nowrap">Posts</a></li>
          <li><a href="#" class="text-pixl-light/60 whitespace-nowrap hover:text-pixl-light/80">Replies</a></li>
          <li><a href="#" class="text-pixl-light/60 whitespace-nowrap hover:text-pixl-light/80">Highlights</a></li>
          <li><a href="#" class="text-pixl-light/60 whitespace-nowrap hover:text-pixl-light/80">Inspiration Streams</a></li>
        </ul>
      </nav>
    </div>
    <!-- Feed -->
    <ol class="pt-4 border-t border-pixl-light/10">
      <!-- Feed item -->
      <li class="flex gap-4 items-start not-first:pt-2.5">
        <a href="/profile" class="shrink-0">
        ...
        <div class="grow pt-1.5">
          ...
          <div class="border-b border-pixl-light/10 pb-5">
            <div class="flex justify-between items-center gap-4">
              <div class="flex gap-2 items-center">
                <p><a href="/profile" class="hover:underline">Michael</a></p>
                <p class="text-pixl-light/40 text-xs">3h</p>
                <p><a href="/profile" class="text-pixl-light/40 text-xs hover:text-pixl-light/60">@mmich_jj</a></p>
              </div>
              <button class="flex gap-0.75 group py-2 cursor-pointer" aria-label="More options">
                <span class="size-1 bg-pixl-light/40 group-hover:bg-pixl-light/60"></span>
                <span class="size-1 bg-pixl-light/40 group-hover:bg-pixl-light/60"></span>
            ...
            <div class="flex justify-between items-center gap-4 mt-6">
              <div class="flex items-center gap-8">
                ...
                <div class="flex items-center gap-1">
                  <button aria-label="Like" class="hover:text-pixl fill-pixl">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        class="h-4.25"
              ...
              <div class="flex items-center gap-3">
                ...
                <div class="flex items-center gap-1">
                  ...
                  <span class="text-sm text-pixl-light/40">save</span>
                </div>
                <!-- share -->
                <div class="flex items-center gap-1">
            ...
            <!-- reply form -->
            <div class="flex mt-8 gap-4 items-start  border-t border-pixl-light/10 pb-4 bg-pixl-light/3">
              <a href="/profile" class="shrink-0">
              ...
              <form action="" class="grow">
                ...
                <textarea class="w-full text-sm resize-none" name="reply" id="reply" placeholder="Reply to Michael's post"></textarea>
                ...
                >
                  ...
                  <button type="submit" class="bg-pixl/10 px-4 py-1 text-sm border text-pixl border-transparent hover:bg-pixl/90 active:bg-pixl/95">Post</button>
                </div>
              </form>
            </div>
          </div>
          ...
          <ol class="">
            <!-- reply -->
            <li class="relative flex gap-4 items-start pt-4 group/li">
              <!-- line through -->
              <div aria-hidden="true" class="absolute left-5 top-0 bottom-0 w-px bg-pixl-light/10 group-last/li:h-4"></div>
              ...
              <div class="grow border-b border-pixl-light/10 pb-5 pt-1.5">
                <div class="flex justify-between items-center gap-4">
                  <div class="flex gap-2 items-center">
                    <p><a href="/profile" class="hover:underline">Adrian</a></p>
                    <p class="text-pixl-light/40 text-xs">1h</p>
                    <p><a href="/profile" class="text-pixl-light/40 text-xs hover:text-pixl-light/60">@adrian</a></p>
                  </div>
                  <button class="flex gap-0.75 group py-2 cursor-pointer" aria-label="More options">
                    <span class="size-1 bg-pixl-light/40 group-hover:bg-pixl-light/60"></span>
                    <span class="size-1 bg-pixl-light/40 group-hover:bg-pixl-light/60"></span>
  ...
  <!-- sidebar -->
  <aside class="w-80 hidden lg:block shrink-0 my-4 overflow-y-auto px-4 -mx-4">
    <input type="text" placeholder="#Search an idea or pixel" class="w-full border-pixl-light/50 text-sm" />
    ...
    <!-- follow idea streams -->
    <div class="p-4 border border-pixl-light/10 rounded-lg mt-4">
      <h2 class="text-pixl-light/60 text-sm">Followed Idea Streams</h2>
      <ol class="flex flex-col gap-2.5 mt-4">
        <li class="flex items-center gap-4 justify-between">
          <p class="text-sm truncate">Breakfast ideas and ways to start your day.</p>
          <button class="bg-pixl-dark/50 hover:bg-pixl-dark/60 active:bg-pixl-dark/75 border border-pixl/50 hover:border-pixl/60 active:border-pixl/75 px-1.5 py-0.5 text-pixl text-2xl leading-none">+</button>
        </li>
        <li class="flex items-center gap-4 justify-between">
        ...
        <li class="flex items-center gap-4 justify-between">
          <p class="text-sm truncate">Tips for Illustrators</p>
          <button class="bg-pixl-dark/50 hover:bg-pixl-dark/60 active:bg-pixl-dark/75 border border-pixl/50 hover:border-pixl/60 active:border-pixl/75 px-1.5 py-0.5 text-pixl text-2xl leading-none">+</button>
        </li>
        <li class="flex items-center gap-4 justify-between">
          <p class="text-sm truncate">Lets talk raw&real</p>
          <button class="bg-pixl-dark/50 hover:bg-pixl-dark/60 active:bg-pixl-dark/75 border border-pixl/50 hover:border-pixl/60 active:border-pixl/75 px-1.5 py-0.5 text-pixl text-2xl leading-none">+</button>
        </li>
      </ol>
      <a href="#" class="text-sm text-pixl-light/50 mt-4 inline-block">Show More</a>
